...
export default function DetailsWeek() {
    ...
    return (
        <div className='h-screen flex justify-center items-center'>
            ...
            <div
                className='text-center w-[95%] lg:w-[70%] h-[80%] mx-auto z-40 relative bg-gradient-to-br from-slate-800/[0.9] to-slate-900/[0.9] pt-4 rounded-2xl border-[3px] border-pink-100 duration-100'>
                ...
                <div className='h-[80%] flex flex-col justify-center text-[1.5em] lg:text-[1.8em] p-4'>
                    ...
                    <div className='flex justify-around'>
                        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.9 }} className='absolute bottom-4 left-4 sm:left-auto'>
                            <Link href='/statistics/details/month'
                ...
                border-[5px] border-black bg-gradient-to-b from-yellow-200 to-orange-500 hover:from-yellow-100 hover:to-orange-400 rounded-xl font-header text-black duration-100'
                        ...
                        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.9 }} className='absolute bottom-4 right-4'>
